...
class EmployeeObreroUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'cedula' => [
                ...
                'min:7',
                'max:15',
                Rule::unique('people')->ignore(Request::route('employees_obrero')->person_id)
            ],
            'rif' => [
                'required',
                'max:20',
                Rule::unique('employees')->ignore(Request::route('employees_obrero'))
            ],
